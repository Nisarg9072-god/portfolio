...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Nisarg Panchal" },
      ...
      { name: "twitter:title", content: "Nisarg Panchal — AI Engineer & Full-Stack Developer" },
      { name: "twitter:description", content: "Building intelligent systems, automation and scalable software." },
    ],
    links: [
      {
        rel: "stylesheet",
